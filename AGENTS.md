...
- n create, c close Herdr layout (done), e edit, s settings, Enter preview, o focus Herdr layout (launch lanes), ? help, q quit (`renderer.destroy()`), Ctrl+C copy, Ctrl+V paste.
